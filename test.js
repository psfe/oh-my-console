...
describe('Logger', function() {
    ...
    describe('log', function() {
        ...
        it('should prefix with id', function() {
            expect(logger.log('bar')).to.contain('[foo]');
        });
        it('should prefix with level', function() {
            expect(logger.log('bar')).to.contain('[log]');
        });
        ...
        it('should support multiple args', function() {
            ...
            ).to.contain('bar false [object Object]');
        });
    ...
    describe('debug', function() {
        ...
        it('should output when DEBUG==id exactly', function() {
            ...
            var logger = Logger('foo');
            expect(logger.debug('bar')).to.contain('bar');
        });
        it('should output when DEBUG prefix matched', function() {
            process.env.DEBUG = 'foo';
            var logger = Logger('foo:bar');
            expect(logger.debug('coo')).to.contain('coo');
        });
